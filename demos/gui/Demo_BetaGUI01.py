...
class testlistener ( BetaGUI.GUIListener ):
    def __init__( self ):
...
#
        ...
        #
        self.guilistener = testlistener()
        self.Gui = BetaGUI.GUI( self.renderWindow) 

#         self.BetaGUIStyle = self.Gui.createStyle("betagui") 
#         self.BetaGUIStyle.mWindow = BetaGUI.WindowStyle("bgui.window", "MgOpen", 12) 
#         self.BetaGUIStyle.addStyle("button", "material: bgui.button height: 20 center: yes font-size: 14 decal-width: 10") 
#         self.BetaGUIStyle.addStyle("titlebar", "material: bgui.titlebar height: 20 font-size: 15") 
#         self.BetaGUIStyle.addStyle("textinput", "material: bgui.textinput height: 20 font-size: 14 decal-width: 5") 

        w = self.Gui.createWindow(100,100,320,164, "betagui", BetaGUI.WFT_MOVE, "SceneNode Inspector", self.guilistener) 
        w.createButton(8,-4, "Cancel",  fun1) 
        w.createButton(-8,-4,"Save",  fun1)
        w.createButton(10,24,"The lazy brown dog", fun1) 
        w.createButton(-10,54,"jumped over the",  fun1) 
        w.createButton(10,64, "fence.",  fun1) 

    def _createFrameListener(self):
        self.frameListener = CameraTrackListener(self.renderWindow, self.camera, self.animationState)
        self.root.addFrameListener(self.frameListener)
        
def fun1 ( Button, FocusState ):
    print "CALLED!!!!!!!!!!!!!!"
    print Button
    print FocusState
