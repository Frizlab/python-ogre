...
#
# the above module with metaclass only works with Python 2.x so now we implement a 2 and 3 compatible version
...
module = MetaClass('module', (object, ), {})
module.active=True
module.pythonModule=False
module.source=[]
module.source_version="head"
module.buildCmds=[]      
...
class boost(module):
    ...
    if isWindows():
        ...
        base = 'boost_1_47'
        if _DEBUG:
            lib = 'boost_python-vc90-mt-gd-1_46_1'
        else:
            lib = 'boost_python-vc90-mt-1_47'
...
class ois(pymodule):
    ...
    CCFLAGS= ' -D_VC80_UPGRADE=0x0710 -DBOOST_ALL_NO_LIB=1 '# -DOIS_DYNAMIC_LIB '
