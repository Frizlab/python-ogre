...
## STARTER TEMPLATE..
## replace watermesh with lowercase project name
## set MAIN_NAMESPACE
...
def ManualInclude ( mb ):
    ...
    if MAIN_NAMESPACE:
        ...
        main_ns = global_ns    
    global_ns.class_('::WaterMesh').include()
    global_ns.class_('::WaterCircle').include()
    global_ns.free_function('::prepareCircleMaterial').include()    
