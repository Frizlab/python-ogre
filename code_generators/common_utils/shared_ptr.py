...
class exposer_t:
    ...
    def expose_single( self, sp_instantiation ):
        ...
        log_info ("SharedPointer Excluded", sp_instantiation, sp_instantiation.decl_string)
...
#             print "SHARED Derived!"
            ...
            sp_derived.exclude()
            log_info ("SharedPointer Excluded Derived", sp_derived, pointee)
...
#             print "SHARED - not class or wrapper"
        ...
        try: 
            ...
            log_warning ("WARNING: Problem with ", pointee.name, " it possibly doesn't have any bases")
            pass
