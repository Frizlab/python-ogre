...
MAIN_NAMESPACE = 'VideoPlayer'
MAIN_NAMESPACE = ''
ogrevideoffmpeg="xxx"  ##do a search and replace on ogrevideoffmpeg
...
# 				
    # not in source
    global_ns.class_('cVideoPlayer').member_function('setSeekFactor').exclude()
    global_ns.class_('cVideoPlayer').member_function('getSeekFactor').exclude()
