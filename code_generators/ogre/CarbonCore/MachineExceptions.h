...
#if (TARGET_CPU_X86 || TARGET_CPU_X86_64) && not defined (__PYTHONOGRE_BUILD_CODE)
#include <xmmintrin.h>
#endif
...
#ifdef __PYTHONOGRE_BUILD_CODE
typedef float __m128 __attribute__ ((__vector_size__ (16)));
typedef float __m128i __attribute__ ((__vector_size__ (16)));
typedef float __m128d __attribute__ ((__vector_size__ (16)));
#endif
