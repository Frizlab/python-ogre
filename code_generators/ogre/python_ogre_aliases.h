...
typedef std::pair<bool, Ogre::SharedPtr<Ogre::Resource> > stdPairSharedPtrResource;
 ...
 typedef std::vector<Ogre::SharedPtr<Ogre::ScriptToken>, Ogre::STLAllocator<Ogre::SharedPtr<Ogre::ScriptToken>, Ogre::CategorisedAllocPolicy<(Ogre::MemoryCategory)0> > > stdVectorSharedPtrScriptToken;
