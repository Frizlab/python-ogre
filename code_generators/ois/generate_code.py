...
from common_utils import log_info as log_info
...
# the 'main'function
#
def generate_code( _GENERATE_CODE = True ):
    messages.disable(
...
if __name__ == '__main__':
    ...
    generate_code()
    log_info('Source code was updated( %f minutes ).' % (  ( time.clock() - start_time )/60 ) )
