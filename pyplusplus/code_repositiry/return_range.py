...
public:
    ...
    static PyObject* postcall(ArgumentPackage const& args, PyObject* result){
        ...
        if( !PyCapsule_CheckExact( result ) ){
            throw std::runtime_error( "Internal error: expected to get PyCapsule Object" );
        }
        value_type* raw_data = reinterpret_cast<value_type*>( PyCapsule_GetPointer( result,NULL ) );
#else
