...
namespace QuickGUI
{
	...
	*/
	...
	public:
        ...
        */
		ComboBox(const Ogre::String& name, const Ogre::Vector4& dimensions, const Ogre::String& material, const Ogre::String& highlightMaterial, Ogre::OverlayContainer* overlayContainer, Widget* ParentWidget);
		virtual ~ComboBox();
		...
		*/
		...
		/**
		* Checks if ListItems, Drop Down Button, or ComboBox Text Label is *hit*.
		*/
	...
	protected:
		...
		Ogre::OverlayContainer* mDropDownListContainer;
