...
namespace QuickGUI
{
	...
	Ogre::ColourValue Character::getHighlightColor()
	{
		return colorValue;
	}

	Ogre::ColourValue Character::getHighlightedTextColor()
	{
		return Ogre::ColourValue(1.0 - colorValue.r,1.0 - colorValue.g,1.0 - colorValue.b,1.0);
	}
