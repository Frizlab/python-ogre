...
namespace QuickGUI
{
	Label::Label(const Ogre::String& name, const Ogre::Vector4& dimensions, GuiMetricsMode positionMode, GuiMetricsMode sizeMode, const Ogre::String& material, Ogre::OverlayContainer* overlayContainer, Widget* ParentWidget) :
		Widget(name,dimensions,positionMode,sizeMode,material,overlayContainer,ParentWidget)
	{
		...
		mTextWidget = new Text(mInstanceName+".Text",Ogre::Vector3(0,0,mCharacterHeight),QGUI_GMM_RELATIVE,QGUI_GMM_RELATIVE,mChildrenContainer,this);
