...
namespace QuickGUI
{
	...
	*/
	...
	public:
        ...
        */
		Window* createWindow(const Ogre::Vector4& dimensions, const Ogre::String& material, GuiMetricsMode positionMode = QGUI_GMM_RELATIVE, GuiMetricsMode sizeMode = QGUI_GMM_RELATIVE);
		/** Create a Window with material, borders, and TitleBar
			@param
			...
			@param
                material Ogre material to define the Window image.
        */
		Window* createWindow(const Ogre::String& name, const Ogre::Vector4& dimensions, const Ogre::String& material, GuiMetricsMode positionMode = QGUI_GMM_RELATIVE, GuiMetricsMode sizeMode = QGUI_GMM_RELATIVE);
		/** Create a Window with material, borders, and TitleBar
			@param
				name Window name, must be unique.
            @param
        ...
        */
		Window* createWindow(const Ogre::String& name, const Ogre::Vector4& dimensions, GuiMetricsMode positionMode = QGUI_GMM_RELATIVE, GuiMetricsMode sizeMode = QGUI_GMM_RELATIVE);
		/** Create a Window with material, borders, and TitleBar
            @param
                dimensions The relative x Position, y Position, width, and height of the window.
			@note
			...
			@note
				Default Skin material for windows will be applied.
        */
		Window* createWindow(const Ogre::Vector4& dimensions, GuiMetricsMode positionMode = QGUI_GMM_RELATIVE, GuiMetricsMode sizeMode = QGUI_GMM_RELATIVE);
	...
	protected:
		...
		Menu* _createMenu(const Ogre::String& name, const Ogre::Vector4& dimensions, GuiMetricsMode positionMode, GuiMetricsMode sizeMode, const Ogre::String& material);
        ...
        */
		Window* _createWindow(const Ogre::String& name, const Ogre::Vector4& dimensions, GuiMetricsMode positionMode, GuiMetricsMode sizeMode, const Ogre::String& material);
