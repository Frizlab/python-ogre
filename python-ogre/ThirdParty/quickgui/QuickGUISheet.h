...
namespace QuickGUI
{
	...
	*/
	...
	public:
        ...
        */
		Window* createWindow(const Rect& dimensions, const Ogre::String& texture, GuiMetricsMode positionMode = QGUI_GMM_RELATIVE, GuiMetricsMode sizeMode = QGUI_GMM_RELATIVE);
		/** Create a Window with material, borders, and TitleBar
			@param
			...
			@param
                material Ogre material to define the Window image.
        */
		Window* createWindow(const Ogre::String& name, const Rect& dimensions, const Ogre::String& texture, GuiMetricsMode positionMode = QGUI_GMM_RELATIVE, GuiMetricsMode sizeMode = QGUI_GMM_RELATIVE);
		/** Create a Window with material, borders, and TitleBar
			@param
				name Window name, must be unique.
            @param
        ...
        */
		Window* createWindow(const Ogre::String& name, const Rect& dimensions, GuiMetricsMode positionMode = QGUI_GMM_RELATIVE, GuiMetricsMode sizeMode = QGUI_GMM_RELATIVE);
		/** Create a Window with material, borders, and TitleBar
            @param
                dimensions The relative x Position, y Position, width, and height of the window.
			@note
			...
			@note
				Default Skin material for windows will be applied.
        */
		Window* createWindow(const Rect& dimensions, GuiMetricsMode positionMode = QGUI_GMM_RELATIVE, GuiMetricsMode sizeMode = QGUI_GMM_RELATIVE);
	...
	protected:
        ...
        */
		Window* _createWindow(const Ogre::String& name, const Rect& dimensions, GuiMetricsMode positionMode, GuiMetricsMode sizeMode, const Ogre::String& texture);
	};
}
