	...
	public:
		...
		*/
		...
		/** Constructor
            ...
            @param
                dimensions The x Position, y Position, and height of the widget.
			@param
        ...
        */
		Text(const Ogre::String& name, const Ogre::Vector3& dimensions, GuiMetricsMode positionMode, GuiMetricsMode sizeMode, Ogre::OverlayContainer* overlayContainer, Widget* ParentWidget);
		virtual ~Text();
