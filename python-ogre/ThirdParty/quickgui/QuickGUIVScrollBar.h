...
namespace QuickGUI
{
	...
	public:
		...
		VScrollBarButtonLayout scrollBarButtonLayout;
		...
		*/
		...
		// Factory method
		static WidgetDesc* factory() { return new VScrollBarDesc(); }
	...
	public:
		...
		*/
		float getPercentage();
		/**
		* Returns the percentage of the slider height compared to the scrolling area. 1.0 means
		* the slider is the entire height of the scroll area.
		*/
		float getSliderHeightPercentage();
