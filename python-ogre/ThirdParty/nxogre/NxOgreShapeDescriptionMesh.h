...
#ifndef __NXOGRE_SHAPEDESCRIPTION_MESH_H__
#define __NXOGRE_SHAPEDESCRIPTION_MESH_H__
...
namespace NxOgre {
	...
	class NxExport TriangleMeshShape : public ShapeDescription {

		public:

			TriangleMeshShape(const NxString& meshName, const ShapeParams& = "");
			~TriangleMeshShape();
