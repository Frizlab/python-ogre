...
namespace NxOgre {
   ...
   class  ActorContactCallback;             //  In files; 
   class  ActorContactCallbackAutoPtr;      //  In files;
   class  ActorGroup;                       //  In files; 
   class  ActorParams;                      //  In files; 
   class  ActorRaycastHit;                  //  In files; NxOgreRaycaster.h, NxOgreRaycaster.cpp
   ...
   class  RenderableActorFactory;           //  In files; NxOgreRenderableActorFactory.h
...
namespace NxOgre {
   ...
   template <typename _first,               //  In files; NxOgreDualIdentifier.h
             typename _second>              //            
      class DualIdentifier;                 //            


   template <typename Ft,                   //  In files; NxOgreDualIdentifier.h
             typename St>                   //            
      class NxEither;                       //            
...
namespace NxOgre {
 ...
 //  typedef Container<NxString, RayCastHit>  RayCastReport;
   ...
   */
   ...
   /** \brief A list of ActorRaycastHits
   */
   typedef Betajaen::SharedList<ActorRaycastHit>  ActorRaycastHits;

   /**
   */
   typedef Betajaen::SharedList<ActorRaycastHit>::SharedListIteratorType  ActorRaycastHitNodeIterator;
   ...
   */
   ...
   /** \brief An identifier for actor/shape groups which has two forms of identification; unsigned
              int or a NxString.
   */
   typedef NxEither<NxU32, NxString>  GroupIdentifier;
   
   
   /** \brief An identifier for materials which has two forms of identification; unsigned int
              or NxString.
   */
   typedef NxEither<NxMaterialIndex, NxString>  MaterialIdentifier;
...
// Public pre-defined vector/quaternion classes for commonly used values
// ----------------------------------------------------------------------

static const NxVec3  NxVec3Zero      = NxVec3(0, 0, 0);
static const NxVec3  NxVec3One       = NxVec3(1, 1, 1);
static const NxMat33 NxMat33Id       = NxMat33(NX_IDENTITY_MATRIX);
static const NxMat33 NxMat33Zero     = NxMat33(NX_ZERO_MATRIX);
static const NxMat34 NxMat34Id       = NxMat34(NxMat33Id, NxVec3Zero);
static const NxMat34 NxMat34Zero     = NxMat34(NxMat33Zero, NxVec3Zero);
static const NxQuat  NxQuatId        = NxQuat(NxMat33Id);
