	...
	*/
	...
	public:
		...
		*/
		...
		inline ResourceStream& operator*() const { assert(pStream); return *pStream; }
		inline ResourceStream* operator->() const { assert(pStream); return pStream; }
		inline ResourceStream* get() const { return pStream; }
		...
		*/
		...
		inline ResourceStream* getPointer() const { return pStream; }

		inline bool isNull(void) const { return pStream == 0; }
	...
	inline bool operator==(ResourceStreamPtr const& a, ResourceStreamPtr const& b){
		return a.get() == b.get();
	}
