/** \file    NxOgreFileResourceStream.h
 *  \brief   Header for the FileResourceStream class.
 *  \version 1.0-20
 *
...
#ifndef __NXOGRE_FILE_RESOURCE_STREAM_H__
#define __NXOGRE_FILE_RESOURCE_STREAM_H__
...
namespace NxOgre {
	...
	/** \brief Resource Stream to a file using the native FILE* functions.
		\note This class should not be created by hand, but through the
			  ResourceStreamPtr class. (See example below)

		\example
			<code>
				ResourceStreamPtr stream("file://file-path");
				stream->size();
				stream->readByte();
			</code>

			<code>
				ResourceStreamPtr stream("file://file-path +write");
				stream->writeString("Hello World");
			</code>

	*/
	class NxPublicClass FileResourceStream : public ResourceStream {
