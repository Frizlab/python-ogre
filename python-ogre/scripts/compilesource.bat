...
call vcvars32
rem cd %_ROOT%\\ogre
rem %_VCBUILD% /useenv Ogre_vc9.sln "Release|Win32"
...
rem cd %_ROOT%\\navi
rem %_VCBUILD% /useenv navi.sln "Release|Win32"

rem cd %_ROOT%\\ogreaddons\\videoplugin\theoravideo\scripts
rem %_VCBUILD% /useenv VC8_TheoraVideo.sln "Release|Win32"
