...
template<> SimpleGUI::MouseCursor* Ogre::Singleton<SimpleGUI::MouseCursor>::ms_Singleton = 0;
...
namespace SimpleGUI
{
		...
		mOnRightBorder(0)
	{
		...
		mMousePointerContainer->setDimensions(mCursorDimensions.x, mCursorDimensions.y);
	...
	{
		return Ogre::Vector2(mPosition.x/mRenderWidthInPixels,mPosition.y/mRenderHeightInPixels);
	}
