...
## STARTER TEMPLATE..
## replace ogrenewt2 with lowercase ogrenewt2 name
## set MAIN_NAMESPACE
...
def ManualExclude ( mb ):
    ...
    exclude=['::OgreNewt::Body::addBouyancyForce'
            ,'::OgreNewt::Body::setCustomForceAndTorqueCallback'
...
def ManualFixes ( mb ):    
    ...
    # World has a default constructor with 2 default arguments so py++ doesn't recognise the constructor
    # as the default one and makes this a no_init class
    inits=['::OgreNewt::World'
            ]
    for c in inits:
        main_ns.class_(c).no_init=False;
...
#     common_utils.copyTree ( sourcePath = environment.Config.PATH_INCLUDE_ogrenewt2, 
#                             destPath = environment.ogrenewt2.generated_dir, 
#                             recursive=False )
