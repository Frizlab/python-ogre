...
protected:
	...
	void setDefaultDepthShadowParams()
		...
		case UNIFORM_FOCUSED:
		case PLANE_OPTIMAL:
			mFixedBias->setScrollPosition(0.0) 
			mGradientBias->setScrollPosition(0.0) 
			break 
		case LISPSM:
			mFixedBias->setScrollPosition(0.009) 
			mGradientBias->setScrollPosition(0.04) 
			break 
	...
	bool handleParamsChanged( CEGUI.EventArgs& e)
	...
	bool handleMaterialChanged( CEGUI.EventArgs& e)
