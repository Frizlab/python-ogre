...
namespace QuickGUI
{
	...
	*/
	...
	public:
		...
		*/
		void addComponentType(const Ogre::String& componentAlias, ComponentType* t);
		/**
		...
		*/
		ComponentType* getComponentType(const Ogre::String& componentAlias);
		/**
		...
		*/
		bool hasComponentType(const Ogre::String& componentAlias);
		/**
	...
	//protected:
		...
		// ComponentName/ComponentType pair
		std::map<Ogre::String,ComponentType*> mComponentTypes;
	};
}
