...
namespace QuickGUI
{
	...
	//protected:
		...
		virtual ~Factory()
		{
   		typename std::map<Ogre::String, BaseClassType*>::iterator it = mInstances.begin();
		...
		template<typename BaseClassType2, typename ClassType>
		static BaseClassType2* createObject(const Ogre::String& param1)
		{
