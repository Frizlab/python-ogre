/** \file    NxOgreLegacyCharacterController.h
 *  \legacy
 *  \version 1.0-20
 *
...
namespace NxOgre {
	...
	class NxPublicClass CharacterMovementVectorController {
		public:
			
			virtual void move(NxVec3 &out, NxVec3 &moveVector, NxQuat &direction, NxVec3 &g, float t, Character*);
	};

	class NxPublicClass CharacterController : public NxUserControllerHitReport, public CharacterMovementVectorController {
