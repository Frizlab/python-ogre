	...
	*/
	class NxPublicClass ResourceCallback {
		...
		public:
			...
			virtual void MaterialAliasLoading(MaterialAlias*, Resource*)                                           {}
			virtual void MaterialAliasLoaded(MaterialAlias*)                                                       {}
			virtual void MaterialAliasLoadingFailed(MaterialAlias*, Resource*, MaterialAlias::Reason)              {}
			virtual void MaterialAliasSaving(MaterialAlias*, Resource*)                                            {}
			virtual void MaterialAliasSavingFailed(MaterialAlias*, Resource*, MaterialAlias::Reason)               {}
			virtual void MaterialAliasSaved(MaterialAlias*)                                                        {}
