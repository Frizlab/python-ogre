...
#define Nx_Version_Commit   22
#define Nx_Version_Codename "T5 Bleeding Edge"

#if (NX_DEBUG == 0)
#   define Nx_Version_Full "NxOgre 1.0.22T5 Bleeding Edge"
#else
#   define Nx_Version_Full "NxOgre 1.0.22T5 Bleeding Edge (Debug)"
#endif
