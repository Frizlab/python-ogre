...
namespace Resources {
	...
	class NxPublicClass Resource : public NxStream {
      ...
      enum ResourceStatus
      {
       RS_Open       = 0, //< Resource is open and ready for use.
       RS_Reserved   = 1, //< Resource is not quite open, but can be used.
       RS_Closed     = 2, //< Resource is closed and cannot be used.
       RS_NotFound   = 3, //< ResourceIdentifier cannot be found and the resource cannot be used.
       RS_Error      = 4  //< There has been error, and the resource cannot be used.
      };
      ...
      /** \brief Get the status of this resource
      */
      virtual   ResourceStatus getStatus(void) const = 0;
      ...
      /** \internal
      */
      ResourceStatus mLastKnownStatus;
	};
