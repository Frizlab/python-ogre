/** \file    NxOgreFluidMesh.cpp
 *  \see     NxOgreFluidMesh.h
 *  \version 1.0-20
 *
...
void FluidMesh::__addToScene() {
	...
	Ogre::SceneManager* scenemgr = (Ogre::SceneManager*) mOwner->getSceneRenderer()->getCustom("scenemanager");

	mNode = scenemgr->getRootSceneNode()->createChildSceneNode();
	mEntity = scenemgr->createEntity(mFluid->getName(), mMesh->getName());
