...
/**
\brief Deprecated; do not use. Consider using sleep damping instead. See also: NxBodyDesc.sleepDamping
*/
  NX_BF_POSE_SLEEP_TEST          = (1<<9),
/**
\brief Filter velocities used keep body awake. Velocities are based on pose deltas, if NX_BF_POSE_SLEEP_TEST flag is raised. The filter reduces rapid oscillations and transient spikes.  See also: NxActor.isSleeping()
*/
...
#endif
  NX_NOTIFY_DUMMY8               = (1<<8),
  NX_NOTIFY_DUMMY9               = (1<<9),
  NX_NOTIFY_DUMMY10              = (1<<10),
  NX_NOTIFY_DUMMY11              = (1<<11),
  NX_NOTIFY_DUMMY12              = (1<<12),
  NX_NOTIFY_DUMMY13              = (1<<13),
  NX_NOTIFY_DUMMY14              = (1<<14),
  NX_NOTIFY_DUMMY15              = (1<<15),
#if NX_SDK_VERSION_NUMBER >= 250
