#ifndef SIMPLEGUIMOUSECURSOR_H
#define SIMPLEGUIMOUSECURSOR_H
...
namespace SimpleGUI
{
	...
	*/
	...
	public:
		/** Constructor
            @param
                dimensions The x Position, y Position, width, and height of the window in Pixels.
			@param
	...
	protected:
		...
		Ogre::Vector2	mCursorDimensions;
