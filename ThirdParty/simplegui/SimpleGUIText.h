#ifndef SIMPLEGUITEXT_H
#define SIMPLEGUITEXT_H
...
namespace SimpleGUI
{
	/** Represents a text component.
		@remarks
		All text in SimpleGUI is done through the Text Widget.
		@note
	...
	*/
	...
	public:
        ...
        */
		Text(const Ogre::String& name, const Ogre::Vector3& dimensions, bool show, Ogre::OverlayContainer* overlayContainer, Widget* ParentWidget);
		~Text();
		...
		*/
		void setTruncationFeedback(const Ogre::String& visualFeedback);
		/**
	...
	private:
		...
		Ogre::String mFeedbackString;

		// Stores pixel locations of where text characters begin and end.
