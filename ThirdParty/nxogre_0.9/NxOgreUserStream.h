...
class NxExport MemoryWriteBuffer : public NxStream {
...
public:
	...
	virtual		Ogre::Real		readFloat()								const	{ NX_ASSERT(0);	return 0.0f;}
...
class  NxExport MemoryReadBuffer : public NxStream
{
public:
