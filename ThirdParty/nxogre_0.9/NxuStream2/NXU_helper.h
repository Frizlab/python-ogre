...
public:
	...
	*/
	virtual void	NXU_notifyScene(NxU32 sno,	NxScene	*scene,	const char* id, const char *userProperties){};
...
\param c The NxuPhysicsCollection to add data to.
\param sceneId   The id of the instance created.
\param sceneName  The name of the scene to be instantiated.
\param rootNode   The root node transform to instantiate the scene relative to.
\param ignorePlane Whether or not to ignore ground planes upon instantiation.  True by default.
\return true if successful.
*/
bool                    addToCurrentSceneInstance(NxuPhysicsCollection &c,const char *sceneId,const char *sceneName,const NxMat34 &rootNode,bool ignorePlane=true,const char *userProperties=0);
