    ...
    void PagingLandScapeTexture_BaseTexture::_loadMaterial()
    {
	    ...
	    {    		
            ...
            if (mMaterial.isNull())
	        {
                ...
                PLSM2_ASSERT  (mMaterial->getTechnique(0) && mMaterial->getTechnique(0)->getPass(0) && mMaterial->getTechnique(0)->getPass(0)->getTextureUnitState(0));
                PLSM2_ASSERT  (mMaterial->getTechnique(1) && mMaterial->getTechnique(1)->getPass(0) && mMaterial->getTechnique(0)->getPass(0)->getTextureUnitState(0));
