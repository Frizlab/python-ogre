        ...
        public:
            ...
            */
			...
			{   
				...
				PLSM2_ASSERT (mHeightData && arraypos < mMaxArrayPos);
            ...
            {
                PLSM2_ASSERT (z < mSize && x < mSize);
                PLSM2_ASSERT (mHeightData);                
                const unsigned int Pos = static_cast< unsigned int > (z * mSize + x);
                PLSM2_ASSERT (mMaxArrayPos > Pos);
            ...
            {
                PLSM2_ASSERT (mHeightData);
                PLSM2_ASSERT (static_cast< unsigned int >(z) < mSize && static_cast< unsigned int >(x) < mSize);
                const unsigned int Pos = static_cast< unsigned int >(z * mSize + x);
                PLSM2_ASSERT (mMaxArrayPos > Pos);
                return mHeightData[ Pos ]; 
            };
