/*
	...
	Brought to you by The Lo-Fi Apocalypse    http://www.lfagames.com/
...
namespace buttonGUI {
	...
	*/
	...
	{
	public:
		buttonEvent(buttonAction a, OIS::MouseButtonID id, button * mainButton, button * dragDroppedButton = NULL, std::string data = "") :
			action(a),
			mouseButton(id),
	...
	public:
		...
		button(std::string &buttonName, std::string &material, buttonPosition &position, short width, short height, buttonManager * mgr, Ogre::Overlay * o, button * parentButton, textScheme &style, bool isActiveButton);
			...
			*/
			...
			/**
			*  Sets limits for the position of this button relative to the upper left corner of the parent. 
			*
		...
		protected:
				...
				short int y1Limit;
				short int y2Limit;
				bool checkTargetPositionX(int x); // used for limiting button movement,  x and y are checked separately so that the button can still slide along the accepted axis
				bool checkTargetPositionY(int y);
	};
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////    ** TEXTINPUTAREA CLASS    **   ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
class textInputArea : public button
	{
		...
		public:
			...
			*/
			...
			/**
			* Send a submit message from buttonMgr with a poitner to this button and the text it contains in additionalData
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////    **  BUTTON  MANAGER CLASS    **   ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public:
		...
		*/
		...
		bool injectMouseMove(buttonPosition &position);
		/**
